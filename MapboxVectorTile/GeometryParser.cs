...
namespace Mapbox.Vector.Tile
{
    ...
    {
        public static List<List<Coordinate>> ParseGeometry(List<uint> geom, VectorTile.Tile.Types.GeomType geomType)
        {
            ...
            while (i < geometryCount)
            {
                ...
                {
                    if (geomType != VectorTile.Tile.Types.GeomType.Point && !(coords.Count == 0))
                    {
                        coords.Add(coords[0]);
                    }
                    length--;
